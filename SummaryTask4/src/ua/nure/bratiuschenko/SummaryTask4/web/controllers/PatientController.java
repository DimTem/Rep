...
public class PatientController extends HttpServlet {
	...
	private static final String DOCTOR_FOR_DOCTOR = "/SummaryTask4/DoctorForDoctor";
	private static final String PATIENT = "/SummaryTask4/Patient";
	...
	protected void doGet(HttpServletRequest request,
		 ...
		 * "src/ua/nure/bratiuschenko/SummaryTask4/pdfFiles/fileFromController.pdf"
		 * );
		 *
		 */
		...
		response.getWriter()
				.print("&nbsp;&nbsp;&nbsp;<a href=/SummaryTask4/jsp/admin/Patients/Discharge.jsp>Discharge from the hospital</a>&nbsp;&nbsp;&nbsp;");
//		response.getWriter()
//		.print("&nbsp;&nbsp;&nbsp;<a href=/SummaryTask4/jsp/admin/Patients/SaveInPdf.jsp>Save in pdf</a>&nbsp;&nbsp;&nbsp;<br>");
		...
		if (request.getParameter("Upsubmit") != null) {
			...
			response.sendRedirect(DOCTOR_FOR_DOCTOR);
		}
		...
		if (request.getParameter("dissubmit") != null) {
			 ...
			 * step 1 // Document document = new Document(); // // step 2 //
			 * PdfWriter.getInstance(document, response.getOutputStream()); //
			 * // step 3 // document.open(); // // step 4 // document.add(new
			 * Paragraph("Hello World")); // // step 5 // document.close(); // }
			 * catch (DocumentException de) { // throw new
			 * IOException(de.getMessage()); // } // // // /** // * A serial
			 * version uid serialVersionUID = 4262544639420765610L;
			 */
