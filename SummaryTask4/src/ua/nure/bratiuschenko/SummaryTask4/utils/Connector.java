...
public class Connector {
	...
	public static final String ADM_PASS = "administrator";
	public static final String USR_USER = "user";
	public static final String USR_PASS = "user";
	
	public Connector(String user, String pass) {
		try {
			Class.forName("com.mysql.jdbc.Driver");
		} catch (ClassNotFoundException e) {
			LOG.error("can not find Connector", e);
		}
		try {
			String url = "jdbc:mysql://localhost:3306/jtj-948";
